...
namespace TechTalk.JiraRestClient
{
    public interface IJiraClient
    {
        ...
        IEnumerable<Issue> GetIssues(String projectKey, String filter, String issueType);
        ...
        IEnumerable<Issue> EnumerateIssues(String projectKey, String filter, String issueType);
    ...
    public class JiraClient : IJiraClient
    {
        ...
        public IEnumerable<Issue> GetIssues(String projectKey, String filter, String issueType)
        {
            return client.GetIssues(projectKey, filter, issueType).Select(Issue.From).ToArray();
        }
        ...
        public IEnumerable<Issue> EnumerateIssues(String projectKey, String filter, String issueType)
        {
            return client.EnumerateIssues(projectKey, filter, issueType).Select(Issue.From);
        }
    ...
    public class Issue : Issue<IssueFields>, IComparable<Issue>
    {
        ...
        public int CompareTo(Issue comparePart)
        {
            ...
            if (comparePart == null)
                ...
                return comparePart.fields.status.id.CompareTo(this.fields.status.id);
        }
    }
}
