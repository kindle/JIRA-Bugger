...
namespace TechTalk.JiraRestClient
{
    public interface IJiraClient<TIssueFields> where TIssueFields : IssueFields, new()
    {
        ...
        IEnumerable<Issue<TIssueFields>> GetIssues(String projectKey, String filter, String issueType);
        ...
        IEnumerable<Issue<TIssueFields>> EnumerateIssues(String projectKey, String filter, String issueType);
